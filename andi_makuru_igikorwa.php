                ...
                <form action="" method="POST" enctype="multipart/form-data">
                  <div class="col-lg-10 col-md-10">
                    ...
                    <select class="form-control" name="status">
                      <option value="Byagenze Neza">Byagenze Neza</option>
                      <option value="Byagenze Nabi">Byagenze Nabi</option>
                    </select>
                  </div>
                <br>
                   <div class="col-lg-10 col-md-10">
                ...
                <?php
                      ...
                      if (isset($_POST['injiza']))
                      {
                          ...
                          $status = str_replace("'", '"' , $status);
                            ...
                            $run = mysqli_query($connection,"INSERT INTO andi_makuru_igikorwa (igikorwa_id,igikorwa_status,igikorwa_report) VALUES ('$igikorwaID','$status','$desc')");
                            if ($run)
                            {
