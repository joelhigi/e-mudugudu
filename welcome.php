    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">ISHUSHO Y'UMUDUGUDU GACACA</h1>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
                 ...
                 <div class="col-lg-10 col-md-10">
                  <label for="dob">Ifoto igaragaza umudugudu Gacaca namasibo arimo</label>
                  <h4 class="m-0 font-weight-bold text-primary">Ishusho y'umudugudu GACACA</h4>

                  <img src="img/welcome/gacacamap.png" height="600px" width="1100">
                  <br>
                  </div>
                </form>
