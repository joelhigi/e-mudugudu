...
d[c]=e,"o"===b[1]&&$(a[e])});a._hungarianMap=d}function J(a,b,c){a._hungarianMap||$(a);var d;h.each(b,function(e){d=a._hungarianMap[e];if(d!==k&&(c||b[d]===k))"o"===d.charAt(0)?(b[d]||(b[d]={}),h.extend(!0,b[d],b[e]),J(a[d],b[d],c)):b[d]=b[e]})}function Ea(a){var b=n.defaults.oLanguage,c=b.sDecimal;c&&Fa(c);if(a){var d=a.sZeroRecords;!a.sEmptyTable&&(d&&"Nta makuru ari muri iyi lisiti"===b.sEmptyTable)&&F(a,a,"sZeroRecords","sEmptyTable");!a.sLoadingRecords&&(d&&"Loading..."===b.sLoadingRecords)&&F(a,
...
a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Ahambere",sLast:"Ahanyuma",sNext:"Ahakurikira",sPrevious:"Ahabanza"},sEmptyTable:"Nta makuru ari muri iyi lisiti",sInfo:"Hari kwerekanwa _START_ to _END_ of _TOTAL_ y'amakuru",sInfoEmpty:"Hari kwerekanwa kuva 0 kugeza 0 y'amakuru 0",
sInfoFiltered:"(yamuye mu makuru _MAX_ yose hamwe)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Buri paji igizwe n'amakuru _MENU_",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Shakisha:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Nta makuru ajyanye n'ibyo ushatse ahari"},oSearch:h.extend({},n.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
