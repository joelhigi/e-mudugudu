        ...
        <div class="container">
            <div class="content">
                <div class="container-fluid">
                    ...
                    <h1>RAPORO Z'UMUDUGUGU WA GACACA</h1>
                    </div>
                  <br/><br/>
                    <form action="makepdf.php" method="post" >
                        <div class="form-row align-items-center">
                            <div class="col-auto my-1">
                                <label class="mr-sm-4" for="slct1" >Hitamo Ubwoko bwa Raporo: </label>
                            ...
                            <div class="col-auto my-1">
                                <br>
                                <button type="submit" class="btn btn-primary" name="report">Zana Raporo</button>
                            </div>
                        </div>
                    </form>
                </div>
