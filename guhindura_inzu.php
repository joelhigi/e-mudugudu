    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">ANDI MAKURU KU NZU</h1>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
                  ...
                  <div class="col-lg-10 col-md-10">
                   <label for="ownername">Aderesi y'inzu</label>
                   <input type="text" class="form-control" value=<?php echo $inzuName;?> name="ownername" required></div>
                   <br>
                   ...
                   <div class="col-lg-10 col-md-10">
                    ...
                    for ($sizeTemp; $sizeTemp >=0; $sizeTemp--){
                        echo "<option value='$arrayInzuId[$sizeTemp]'";
                        if($igipanguID==$arrayInzuId[$sizeTemp]){echo "selected";}
                        echo">Igipangu cya $arrayInzuName[$sizeTemp] (Kode: $arrayInzuAddress[$sizeTemp])</option>";
                    }
                    ...
                    <div class="col-lg-10 col-md-10">
                     <label for="inzudata">Icyo inzu yagenewe gukorerwamo</label>
                     <input type="text" class="form-control" value="<?php echo $details;?>" placeholder="" name="inzudata"></div>
                     <br>
                     ...
                     <div class="col-lg-10 col-md-10">
                       ...
                       <select class="form-control" name="status">
                         <option value="Iratuwe" <?php if($status=="Iratuwe"){echo " selected";}?>>Iratuwe</option>
                         <option value="Irakodeshwa" <?php if($status=="Irakodeshwa"){echo " selected";}?>>Irakodeshwa</option>
                       </select>
                     </div>
                     <br>
                <hr>
                 ...
                 <br>
                   ...
                   <div class="col-lg-10 col-md-10">
                    ...
                    $connect = new mysqli("localhost","root","","umudugudu",3306);
                      ...
                      $queryUkodeshaLn = $connect -> query("SELECT `umuryango_chef` FROM `umuryango` ORDER BY `umuryango_id` ASC");
                      $queryUkodeshaId = $connect -> query("SELECT `umuryango_id` FROM `umuryango` ORDER BY `umuryango_id` ASC");
                    ...
                    for ($sizeTemp; $sizeTemp >=0; $sizeTemp--){
                      ...
                      if(mysqli_num_rows($sql)==0){
                        ...
                        if($ukodeshaId == $ukodeshaFamId){echo " selected";}
                        echo">$arrayUkodeshaLn[$sizeTemp]</option>";
                      }
                    ...
                    if(is_null($ukodeshaFamId)){echo " selected";}
                    echo ">Nta muryango utuyemo</option>";
                ...
                <?php
                  ...
                  if(isset($_POST['injiza']))
                  {
                    ...
                    $choice = $_POST['status'];
                      ...
                      $family = $_POST['selectUbamo'];
                      $status = $_POST['status'];

                      if($family!='NULL')
                      {
                        $insert1 = "UPDATE nyirinzu SET umuturage_id='$nyirinzu',umuryango_id='$family' WHERE inzu_id='$houseID'";
                      }
                      else{
                        $insert1 = "UPDATE nyirinzu SET umuturage_id='$nyirinzu',umuryango_id=NULL WHERE inzu_id='$houseID'";
                      }



                      $insert3 = "UPDATE inzu
                                  SET owner_name='$inzuName', igipangu_id='$igipanguID', status_turwa_kodeshwa='$choice', inzu_details='$details'
